                ...
                <div class="col-12 mb-3 bg-light" id="isiForm">
                    ...
                    <?php 
                        $data_soal = [
                            [
                                "no" => "1",
                                "soal" => "Idris sedang melihat planet dengan benar-benar melihat.",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "2",
                                "soal" => "Pemain bola itu menendang bola dengan tendangan yang keras",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "3",
                                "soal" => "Kita telah makan nasi dua kali",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "4",
                                "soal" => "Mereka belajar bahasa arab dengan giat",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "5",
                                "soal" => "Saya duduk diatas kursi dengan sesungguhnya",
                                "jawaban" => ""
                            ],
                        ];
                    ?>
