            ...
            <div class="row">
                ...
                <?php 
                    $data_soal = [
                        [
                            "no" => "1",
                            "soal" => "Husain ingin makan lele bukan ayam",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "2",
                            "soal" => "Kita akan pergi ke gunung dan hutan",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "3",
                            "soal" => "Mereka mendaki gunung hingga puncak gunung",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "4",
                            "soal" => "Fatimah berwudhu lalu sholat",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "5",
                            "soal" => "Kita solat kemudian kita membaca al-Qur’an",
                            "jawaban" => ""
                        ],
                    ];
                ?>
