            ...
            <div class="row">
                ...
                <?php 
                    $data_soal = [
                        [
                            "no" => "1",
                            "soal" => "Mereka telah pulang dari sekolah, iya dari sekolah",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "2",
                            "soal" => "Anak itu pintar, iya pintar",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "3",
                            "soal" => "Bapak itu memasak nasi dengan sendiri",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "4",
                            "soal" => "Murid-murid membaca al-Qur’an semuanya",
                            "jawaban" => ""
                        ],
                        [
                            "no" => "5",
                            "soal" => "Anak (pr) itu mengumpulkan uang dengan dirinya sendiri",
                            "jawaban" => ""
                        ],
                    ];
                ?>
