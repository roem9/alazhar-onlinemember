                ...
                <div class="col-12 mb-3 bg-light" id="isiForm">
                    ...
                    <?php 
                        $data_soal = [
                            [
                                "no" => "1",
                                "soal" => "Kita belajar didalam kelas",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "2",
                                "soal" => "Kita puasa pada hari senin dan hari kamis",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "3",
                                "soal" => "Murid-murid bercakap-cakap dengan bahasa arab di depan asrama",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "4",
                                "soal" => "Anak-anak bermain voly dibelakang rumah",
                                "jawaban" => ""
                            ],
                            [
                                "no" => "5",
                                "soal" => "Kucing itu sedang makan tikus disamping pohon",
                                "jawaban" => ""
                            ],
                        ];
                    ?>
