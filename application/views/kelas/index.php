                ...
                success : function(data){
                    ...
                    if(data.kelas.length != 0){
                        data.kelas.forEach(kelas => {
                            if(kelas.sertifikat == 1)
                                sertifikat = `<a href="<?= base_url()?>hifdzi1/syahadah/`+kelas.id_sertifikat+`" target="_blank" class="btn btn-sm btn-secondary mr-1"><i class="fa fa-award"></i></a>`;
                            else 
                                sertifikat = "";
